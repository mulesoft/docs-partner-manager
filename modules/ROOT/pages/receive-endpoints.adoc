...
* Receive from Partners endpoints act as source endpoints in inbound message flows that receive B2B messages from partners either directly or via third-party connections.
...
* xref:endpoint-https-receive.adoc[HTTP and HTTPS]
