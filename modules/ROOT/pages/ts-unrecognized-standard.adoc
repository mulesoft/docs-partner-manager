...
* You do not recognize the partner because they are not set up by you in Anypoint Partner Manager.

== Solution

If you encounter any of these situations, then verify with your partner that they are sending valid X12 format files that align with the message flows you have created and associated with that partner.
