...
The only information you need to create a new trading partner is the name and a single identifier related to tha partner.
...
. From within your Anypoint Partner Manager environment, select `Partners` from the left-hand navigation.
...
. Click `Create Partner` to create your trading partner. At this point, your trading partner has been created within the Anypoint platform, so you can go to setup message flows related to this partner.

== Update a Trading Partner's Profile

You can also add more details related to a trading partner's profile. You can add the following information for each trading partner from the `Partners` selection in the left-hand navigation:
...
. Click on the `Save` button after providing all the necessary information. When the trading partner's profile is successfully updated, you receive a confirmation message.
