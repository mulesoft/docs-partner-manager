...
.. In the *Type* list, select one of the following identifiers:
* *AS2 Identity*
* *Reference ID*
* *X12-GS*
* *X12-ISA*
.. In the *Identifier Value* field, enter a value to uniquely identify your partner.
.. Optionally, if you selected *X12-ISA* for *Type*, you must also select a *Qualifier* value from the list.
