...
You can also add more details related to this trading partner. You can add the following information for each trading partner from the *Partners* selection in the left-hand navigation:
