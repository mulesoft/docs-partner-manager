...
From the Partner or Host pages, you can delete any endpoints that are not used in any message flow configurations.
...
From within Endpoints: Receive from partners or Endpoints: Targets at <partner name> for the Host, or Endpoints: Send to <partner name> for your partners.

. If you can’t remember what to search for, you can scan the list for any endpoints that don’t have a message flow associated with them.
