...
|image:pm-annotation-3.png[]|Transform |DataWeave map used to transform the JSON or XML formats to EDIFACT or X12. The map must have Java output (`output application/java`) to transform JSON or XML to EDIFACT. a| N/A
