...
*Vijay, please make sure these descriptions are correct.*
...
+
When there is a routing failure, this acknowledgement indicates whether Partner Manager validated the message.
