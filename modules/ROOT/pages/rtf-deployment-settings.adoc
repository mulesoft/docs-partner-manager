...
| Runtime Version | Mule runtime engine version to run your Runtime Fabric instance. a| 4.6.0
...
|Host a| The ingress template used for Partner Manager application deployments. For more information about ingress templates, see xref:runtime-fabric::custom-ingress-configuration.adoc[Ingress Templates]. 

[NOTE]
On the Partner Manager host page, the *URL* column of the *Endpoints* section shows a placeholder URL for RTF Ingress endpoints. Partner Manager doesn't have visibility into the RTF configuration.

| Selected by Runtime Manager
