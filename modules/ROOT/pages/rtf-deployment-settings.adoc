...
|Host | The ingress template used for Partner Manager application deployments. For more information about ingress templates, see xref:runtime-fabric::custom-ingress-configuration.adoc[Ingress Templates]. | Selected by Runtime Manager
