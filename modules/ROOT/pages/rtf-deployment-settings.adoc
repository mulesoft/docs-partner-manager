...
[NOTE]
When viewing RTF Ingress endpoints in the *URL* column of the *Endpoints* section on the Partner Manager host page, a placeholder URL is shown. Partner Manager doesn't have visibility into the RTF configuration.
