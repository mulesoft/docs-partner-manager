...
[NOTE]
In the *URL* column of the Endpoints section on the Partner Manager host page, the ingress URL is replaced by a placeholder because the platform lacks visibility into the Runtime Fabric configuration.
