...
[NOTE]
When viewing RTF Ingress endpoints in Anypoint Partner Manager, a placeholder URL displays. Partner Manager doesn't have visibility into the RTF configuration.
