...
When you create translation or reference maps for inbound or outbound message flows, you can access source message attributes in those maps. You can then map the attributes in the translated message payload or use the attribute values in your mapping logic to perform dynamic condition execution.
...
* customProtocolHeaders
+
For security reasons, only the headers with the prefix 'x-apm-' are made available in the 'b2bMessageContext' variable.
* messageId   
