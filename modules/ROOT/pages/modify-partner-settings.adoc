...
+
Click *Edit* in the *About* section, click the appropriate link, and make the desired modifications.
+
* Delete a contact
+
...
a| * Modify
+
Click the links in the *Validation and acknowledgement settings* section, click a protocol link, and make the desired modifications.
a|
