= Configuring CloudHub 1.0 Deployment Settings
:page-aliases: partner-manager::cloudhub-deploy-options.adoc

To configure settings for deploying Anypoint Partner Manager to CloudHub 1.0, access the business unit and environment for which you want to deploy Partner Manager and then follow these steps:
...
| Runtime Version | Mule runtime engine version to run Partner Manager applications. a| 4.6.0
