...
| CloudHub Region |Region in CloudHub to which you want to Partner deploy Manager runtime applications. You can't change the region if message flows are deployed to the existing region. To change the region in this case, you must undeploy the message flows. You can redploy the message flows after you change the region.| Retrieved from the business group's Runtime Manager setting
