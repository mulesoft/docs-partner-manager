...
. Follow the steps on the xref:runtime-manager::cloudhub/vpc-upgrade.adoc[] page to upgrade your CH1 Anypoint Virtual Private Cloud (Anypoint VPC) to a CH2 private space.
. In Runtime Manager:
