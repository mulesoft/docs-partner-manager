...
You can deploy Partner Manager runtime applications to CloudHub 1.0, CloudHub 2.0, or Anypoint Runtime Fabric. To configure deployment options, use the *Partner Manager Settings* page in access management.
