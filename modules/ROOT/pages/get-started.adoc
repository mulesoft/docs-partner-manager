...
You can deploy Partner Manager runtime applications to CloudHub 1.0 or Runtime Fabric. To configure deployment options, use the *Partner Manager Settings* page in Anypoint Access Management.

For more information, see xref:cloudhub-deploy-options.adoc[] or rft-deploy-options[].
