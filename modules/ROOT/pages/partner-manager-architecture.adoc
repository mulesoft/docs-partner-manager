...
With Anypoint Partner Manager, you can deploy B2B integration message flows to a MuleSoft-hosted CloudHub iPaaS platform or to an Anypoint Runtime Fabric instance.
