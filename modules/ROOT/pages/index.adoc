...
NOTE: Current Anypoint Partner Manager solutions will continue to be supported in accordance with the https://www.mulesoft.com/legal/support-maintenance-terms[Product Support and Maintenance Terms] but will not be available for new customers or upgrades. For the latest version of Anypoint Partner Manager, please leverage the latest generation of our solution available https://docs.mulesoft.com/partner-manager/2.0/[here]. Contact your MuleSoft representative for the latest information about MuleSoft's B2B solutions.
