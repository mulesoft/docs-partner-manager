...
[NOTE]
Support for Anypoint Partner Manager 1.0 will continue in accordance with the https://www.mulesoft.com/legal/support-maintenance-terms[Product Support and Maintenance Terms] but is not available for new customers or upgrades. For the latest version of Anypoint Partner Manager, see https://docs.mulesoft.com/partner-manager/2.0/[About Partner Manager] documentation. Contact your MuleSoft representative for the latest information about MuleSoft's B2B solutions.
