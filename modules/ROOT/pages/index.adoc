...
For other formats, such as CSV, JSON, and XML, Partner Manager extracts the identifiers from data payloads or a message contact by dynamically executing the reference mapping supplied with the message type definition.
