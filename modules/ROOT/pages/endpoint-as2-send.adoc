= *Not Done* AS2 Send Endpoint Settings

Your organization's AS2 send endpoint settings determine which endponts from which to send outbound EDI messages either directly to partners or to partners through 3rd party connections.
