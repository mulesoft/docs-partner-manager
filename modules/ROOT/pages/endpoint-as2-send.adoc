...
An AS2 Send to Partners endpoint can act as:

* A Target endpoint in an outbound message flow to which transformed B2B messages are sent to partners either directly or via third-party connections
