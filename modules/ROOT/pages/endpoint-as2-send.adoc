...
The AS2 Send to Partners endpoint settings configure the target endpoint in an outbound message flow to which transformed B2B messages are sent to partners either directly or via third-party connections.

Either a partner or a third-party can own AS2 send endpoints.
