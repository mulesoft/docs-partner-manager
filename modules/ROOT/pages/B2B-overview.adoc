...
You'll need to perform some tasks before you can begin transmitting messages with your trading partners. A transmission is a single communication event during which a payload is transferred between two business entities. These payloads can contain one or more business messages.
...
Before you configure your message flows to send and receive messages with your trading partners, you'll need to collect some information from them. You’ll also need an understanding of how your backend systems work.
...
** Acknowledgement endpoints - Your partners provide you with endpoint configurations that can be used by you to send acknowledgement messages (like a X12 997 or a X12 999) back to them. Acknowledgements are typically sent back to trading partners corresponding to one or more B2B messages you receive from them.

* Your digital certificates (such as X.509 certificate).
...
* Your Trading Partner's digital certificates (such as X.509 certificate).
