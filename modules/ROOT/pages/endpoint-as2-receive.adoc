...
NOTE: Each AS2 receive endpoint configuration gets deployed as an individual Mule app in the runtime. Consider reusing existing AS2 receive endpoint configuration across partner message flows.
