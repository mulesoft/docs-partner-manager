...
a|Defines how the ingress path name is determined within Runtime Fabric endpoint settings.

* Select Default to use `receive-as2` as the path.
* Select Custom to specify the path name.
* Select BasePath to use the base path of the endpoint.
| No
