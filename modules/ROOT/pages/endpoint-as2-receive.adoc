...
.Mapping an input path to an target app and output path in the DLB.image::URL-mapping-rules.png[image::URL-mapping-rules-http.png[URL mapping rules for the AS2 protocol in the DLB settings]]
