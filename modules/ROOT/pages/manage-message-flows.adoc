...
. From within your Anypoint Partner Manager sandbox or production environment, click *Message Flows* in the upper left and select a message flow.

. Choose the message flow click *<Message flow name>* to expand it.

. If you want to add an identifier to the message flow, click *See All* > *New*.
