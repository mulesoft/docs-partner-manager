...
You change any of these by opening an existing message flow and edit in the sections you intend to modify. Consider that modifying identifiers impacts deployed message flows.
