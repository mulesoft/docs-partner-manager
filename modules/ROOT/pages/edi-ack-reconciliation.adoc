...
+
When you review an X12 997 or CONTRL rejection, you see the X12 997 or EDIFACT CONTRL payload received from your trading partner. For example (for X12 997):
+
...
. Optionally, download the X12 997 or CONTRL payload by clicking *Download*.
