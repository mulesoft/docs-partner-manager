...
+
When you review an X12 997 or CONTRL rejection, you see the payload received from your trading partner.
+
...
. Optionally, download the payload by clicking the *Download* button.
