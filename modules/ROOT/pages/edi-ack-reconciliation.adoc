...
+
When you review an X12 997 or CONTRL rejection, you see the payload received from your trading partner.  for example (for X12 997):
+
...
. Optionally, download the 997 or CONTRL payload by clicking *Download*.
