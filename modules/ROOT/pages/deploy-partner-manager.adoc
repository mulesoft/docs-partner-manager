...
. In the *Configure a Partner Manager environment* window, configure either xref:cloudhub-deployment-settings.adoc[CloudHub 1.0 deployment settings], xref:cloudhub2-deployment-settings.adoc[CloudHub 2.0 deployment settings], or xref:rtf-deployment-settings.adoc[Runtime Fabric deployment settings].
...
. In the *Configure a Partner Manager environment* window, configure xref:cloudhub-deployment-settings.adoc[CloudHub 1.0 deployment settings], xref:cloudhub2-deployment-settings.adoc[CloudHub 2.0 deployment settings], or xref:rtf-deployment-settings.adoc[Runtime Fabric deployment settings].
