...
. Locate a transmission you are interested in viewing. Use the search box to find the transmission based on:
+
** the trading partner name, or
** the message type, or
** the filename, or
** the control number, or
** the endpoint, or
...
+
** The status of the transmission indicating either a success (Green check mark), or failure (red circle with an exclamation point).
