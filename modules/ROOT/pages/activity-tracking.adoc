...
[NOTE]
Only five partners appear in the *Partner name* list; however, you can enter characters in the search box to access partners that do not appear in the list.
