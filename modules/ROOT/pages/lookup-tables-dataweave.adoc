...
Use this function only with tables of type *Composite Key Lookup*.
...
Use this function only with tables of type *Cross-Reference Lookup*.
...
import * from modules::b2blookuputils
---
b2bCrossReferenceLookup("Item Code Mapping", "Internal SKU", "SKU-5520", true)
----
...
import * from modules::b2blookuputils
---
b2bGenericLookup("Payment Terms Mapping", true)
----
