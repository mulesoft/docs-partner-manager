= Creating a Translation Map For Inbound EDIFACT to JSON or XML
...
+
The new EDIFACT message structure displays in the Transform Message grapichal view input pane, and your application message structure displays in the output pane of this view:
+
