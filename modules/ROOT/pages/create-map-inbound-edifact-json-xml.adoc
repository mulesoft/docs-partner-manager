...
+
image::pm-inbound-map-1.png[Transform Message component add payload metadata]
+
. Click *Add*.
...
+
+
image::pm-inbound-map-2.png[Transform Message component add payload metadata]
+
