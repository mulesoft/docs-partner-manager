...
. Do either of the following:
* Select an existing send to partner endpoint and click *Select*.
+
...
+
* Click *New* to create a new send to partner endpoint, as described in xref:create-endpoint.adoc[Create and Configure Endpoints].
