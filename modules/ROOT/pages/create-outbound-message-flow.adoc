...
.. In the *Select an endpoint: Receive acknowledgement from <parter>* window, click *Select* to specify the endpoint from which to receive the acknowledgement transactions from your partner. +
