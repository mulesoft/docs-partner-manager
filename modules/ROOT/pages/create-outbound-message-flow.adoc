...
The target message type in an outbound message flow defines the structure of the messages that Partner Manager sends to the partner, either directly or via a third party connection. Partner Manager supports the AS2, FTP, and SFTP formats for target message types.
