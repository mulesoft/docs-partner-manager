...
Configuring the send to message type also involves configuring acknowledgements (optional for X12 and EDIFACT), creating custom EDIFACT settings (optional), and selecting EDIFACT identifiers to use for routing the outbound messages.
