...
. In the *Mark overdue after* field, accept the default value of *24 Hours* or configure when to mark the outbound transaction as overdue for an acknowledgement, according to the SLAs you have with your partner.
