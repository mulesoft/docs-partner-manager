...
Selecting the checkbox (enabling) for any of these options means that all the X12 documents either meet this condition criteria or receive a 997 failure message:
