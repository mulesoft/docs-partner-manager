...
The target at host application message structure (JSON or XML) defines the way in which inbound EDI transactions are translated and sent to your back-end applications.
...
[[source-at-host]]
== Source at Host
The source at host application message structure (JSON or XML) defines the way in which your back-end applications translate outbound EDI transactions and sent them to your trading partners.
