...
* <<message-flow-partners.adoc,Receive From Partners Message Type Settings>>
* <<message-flow-partners.adoc,Send to Partners Message Type Settings>>
* <<message-flow-target-at-host.adoc,Target at Host Message Type Settings>>
* <<message-flow-source-at-host.adoc,Source at Host Message Type Setting>>
