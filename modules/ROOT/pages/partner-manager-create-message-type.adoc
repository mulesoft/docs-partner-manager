...
Message types define the structure of the transactions that Anypoint Partner Manager receives or sends. Partner Manager supports the following message types:

* Receive from Partners
+
Message type of the messages sent from a partner to the host
+
* Target at Host
+
Message type of the messages sent from the host to the backend applications
+
* Source at Host
+
Message type of the messages sent from the backend applications to the host
+
* Send to Partners
+
Message type of the messages sent from the host to a partner
