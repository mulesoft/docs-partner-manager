...
After you create Receive from Partner and Source at Host message types, you can add up to five customized message attributes to them. For information, see xref:use-custom-message-attributes.adoc[Using Custom Message Attributes with Message Types].
