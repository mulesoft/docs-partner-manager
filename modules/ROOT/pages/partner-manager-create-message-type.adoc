...
After you create Receive from Partners and Source at Host message types, you can add up to five custom message attributes to them. For information, see xref:use-custom-attributes.adoc[Using Custom Message Attributes with Message Types].
