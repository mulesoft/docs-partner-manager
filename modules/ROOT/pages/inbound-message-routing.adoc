...
image::pm-inbound-message-routing2.png["Inbound message processing for AS2, HTTP, and SFTP/FTP protocols", window=_blank, link={imagesdir}/pm-inbound-message-routing2.png]
...
image::pm-dps-inbound-processing2.png["Message flow processing and matching"]
