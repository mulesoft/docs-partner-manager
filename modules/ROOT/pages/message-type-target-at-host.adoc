...
The Target at Host message type defines the structure of the messages that Partner Manager sends to the backend applications. Use the following settings to create a Target at Host message type:
