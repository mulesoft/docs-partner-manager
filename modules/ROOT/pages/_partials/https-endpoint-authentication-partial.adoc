...
|x
|Scope
|Permissions granted to a client application. Enter values as a space-separated list, where each string represents a permission requested by the client application.  The field only applies to HTTP endpoints.
|No
|===
// end::https-send[]
