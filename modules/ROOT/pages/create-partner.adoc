...
After you create a partner and configure partner-level endpoints (if needed), set up message flows. *Do you have to create partner endpoints? Can you use only host endpoints for a partner*)
