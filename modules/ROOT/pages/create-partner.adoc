...
Partner Manager environments support a maximum of 1,000 partners each. To onboard more partners, create an additional environment.
...
|
xref:as2-encoding.adoc[AS2 Receive Settings]
|===
