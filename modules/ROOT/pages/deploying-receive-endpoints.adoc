...
You can view this URL by either selecting the receive endpoint from your deployed message flow or clicking the endpoint name from the endpoints list. For example:
