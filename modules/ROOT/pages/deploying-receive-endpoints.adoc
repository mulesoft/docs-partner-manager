...
To see this URL, select the receive endpoint from a deployed message flow or click the endpoint name from the endpoints list to view the endpoint details. For example: 

image::pm-receive-endpoint-url.png
