...
You can view the runtime application name, internal URL, and external URL for a deployed endpoint from the *Endpoint* details page or the *Receive* section of your message flow. For example:
