...
Your organization or Anypoint busines group is considered the host partner in Anypoint Partner Manager.
...
. Select the name of your organization from the navigation pane on the left-hand side. From here you configure the following based on your indentifier and certificate type. This includes any global settings you need to modify, and the location of your payload storage configuration.
