...
* Configure details associated to the Payload Storage API (the same one that was configured as part of the the Setup instructions).
...
Refer to xref:x12-identity-settings.adoc[Identifiers] for information on deleting an identifier.
