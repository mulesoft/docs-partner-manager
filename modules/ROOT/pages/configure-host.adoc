...
* Storage for your B2B message payloads. Configure the HTTPS location where you store payloads containing the messages you send to and receive from partners.
