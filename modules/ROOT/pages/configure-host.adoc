...
* Configure details associated to the Payload Storage API (the same one you configured as part of the the Setup instructions).
...
You can configure the your indentifiers, certificates, and the location and configuration of your payload storage.
...
. Provide a value for your identifier (and qualifier for X12-ISA) and click *Create identifier* to save your changes. See xref:x12-identity-settings.adoc[Identifiers] for more information on X12-ISA settings.
...
Refer to xref:manage-message-flows.adoc[Manage Message Flows] for information on deleting an identifier.
