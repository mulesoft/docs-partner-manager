...
For more information on your protocol type refer to:
...
. If you need to change any of the information that was completed when the payload storage was set up, click *Edit* within the *Payload storage* section.

For example, URL location, timeout settings, and acknowledgments.

Refer to xref:x12-identity-settings.adoc[Identifiers] for information on deleting an identifier.

Refer to xref:endpoints.adoc[Endpoint Types and Protocols] for information on deleting an endpoint.
