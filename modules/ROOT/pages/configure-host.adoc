...
. Within the `Payload storage` section, optionally click *Edit* to change any of the information that was completed when the payload storage was set up. For example, URL location, timeout settings, acknowledgments.
