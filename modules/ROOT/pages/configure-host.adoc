...
When EDIFACT messages received from your trading partners do not contain a UNA segment, Partner Manager uses the delimiters specified in the Global EDIFACT Receive settings defined under the host organization’s profile to parse the received EDIFACT payloads:
