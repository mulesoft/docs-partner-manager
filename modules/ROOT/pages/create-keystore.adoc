...
== Keystore Settings
Use these to set up AS2 host keystore settings for AS2 receive and send endpoints.
...
== Create a Keystore
You can create and reuse a AS2 host keystore for use in subsequent new endpoint configurations.
