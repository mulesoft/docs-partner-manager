= Create a Message Flow from Your Partner
...
Your organization is typically referred to as the host. The enterprise or customer you interact with is referred to as your trading partner.
...
You can begin to monitor the deployed flow from the Activity page.
