...
When receiving a B2B message from your trading partner, there may be more than one URL.
For example, a receiving URL, and a URL for receiving asynchronous MDNs (Message Disposition Notifications).
If this is the case, you only need to configure the Receiving URL.
