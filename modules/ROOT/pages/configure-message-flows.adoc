...
TIP: You can expand each section of the message flow by clicking it. A green checkmark next to any a section indicates that it is complete. When you complete all of the sections i.e. have a green check mark againt all sections in the flow, you can `Deploy` your message flow and start receiving messages from your partner.
