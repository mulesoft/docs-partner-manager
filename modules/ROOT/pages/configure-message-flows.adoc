...
. Associate an existing partner that you created, or click the *New Partner button* to create one. If you are creating a new partner, fill in the receiving endpoint. +
