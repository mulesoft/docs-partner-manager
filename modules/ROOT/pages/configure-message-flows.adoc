...
== Select an Existing Trading Partner

. In the `Select a partner` window, search for the trading partner by name. 

. Once you find a match, click on the corresponding row, and click the *Select* button.

Once you've edited a partner you can configure your message flow to receive messages from the selected trading partner.
