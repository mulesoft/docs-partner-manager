...
This is the same as xref:configure-partner.adoc#create-a-trading-partner[Create a Trading Partner] except that when you are finished, you'll click *Create Partner and Message Flow*. You can add more information to the partner later.
...
Once a message flow is successfully deployed, you can track messages processed by it from the Activity page.
