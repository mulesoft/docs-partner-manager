...
Create an inbound message flow to receive EDI messages from your trading partners, validate, transform, and then send the translated application (JSON/XML) message to your back-end applications.
