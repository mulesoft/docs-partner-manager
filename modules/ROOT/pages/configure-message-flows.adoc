...
. In the *Acknowledgment* section, select the check box next to *Sent 997 functional acknowledgment* if you expect your partner to return functional acknowledgments.
.. Click *Select*.
.. In the *Select an endpoint: Send acknowledgment to <parter>* window, click *Select* to specify the endpoint from which to receive the acknowledgment transactions from your partner. +
