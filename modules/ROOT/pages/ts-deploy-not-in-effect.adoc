...
Depending on when you made the configuration changes to your message flows in Partner Manager and deployed them, it can take up to five minutes for changes to take effect on the runtime.
