...
Create and manage lookup tables in Partner Manager to support value translation across systems. For an overview of lookup table types and benefits, see xref:lookup-tables-overview.adoc[].
...
* *Unique*: Column values can't be duplicated across rows.
. Click *Save*.
...
For DataWeave function reference and examples, see xref:lookup-tables-dataweave.adoc[].
