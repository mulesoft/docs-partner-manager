...
NOTE: If you wish to view the raw payloads of the files you receive or send, please select the option `Allow users to download payloads` while configuring your payload storage API.
