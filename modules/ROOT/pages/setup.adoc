...
. If you want to view the raw payloads of the files you receive or send, select `Allow users to download payloads` while configuring your payload storage API.
