...
_**Note to Maria** - Please add an image of the Anypoint Platform page that shows Partner Manager on the_
...
* You need to designate runtimes to deploy the B2B Gateway i.e. the Mule application that processes your B2B transactions. Please ensure you have the needed runtime capacity to handle your B2B transaction load. If you are not sure about the capacity you need to handle your B2B transactions, please contact your MuleSoft representative.

NOTE: The server group associated to your B2B Gateway need to be named "B2BServerGroup" (the name is case sensitive).

* A storage to persist your B2B message payloads. Anypoint Partner Manager enables you to connect your own storage (such as a database, Amazon S3, Azure Blob Storage, and so forth). To connect to your storage, you will need to establish an API that can be registered with Anypoint Partner Manager to connect to the storage.
...
- Configure your Payload Storage
...
The first thing that you'll want to do is to configure your own profile. Your profile defines important information used to identify you with your partners. Select tab with your organizations name from the left-hand side menu to get started configuring your profile.
...
* Download the pre-packaged API and integration implementation from here.
