...
All other configurations on the your organization's profile are optional at this point. Many of these details will be populated as you setup the Message flows later on.
