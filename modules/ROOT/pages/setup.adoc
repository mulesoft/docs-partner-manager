...
For example, if you are using AS2, you'll need to understand from your administrator what the hostname is so you can tell your partner where to send the AS2 transmission.
