...
You should be familiar with the following concepts before setting up Partner Manager:
...
Before you set up your message flows to send and receive messages with your partners, you'll need to collection some information from them. You’ll also need to understand how your backend systems work. Use this checklist to help organize the information you need. 
...
There are two Administrator roles for Anypoint Partner Manager. Both roles have unrestricted access, but one role works in a Production environment and one works in a Sandbox environment. 
