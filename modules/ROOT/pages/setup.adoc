...
. For each environment, set up your Runtime by https://docs.mulesoft.com/mule-runtime/4.2/runtime-installation-task[Download and Install Mule] and unzipping it.
...
. Start the Mule runtime and verify it shows as 'Running' in Anypoint Runtime Manager.
