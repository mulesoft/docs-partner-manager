...
* Send to partners
+
Target endpoint in an outbound message flow to which transformed B2B EDI messages are sent to the partners either directly or via a 3rd party connection
+
* Target at host
+
