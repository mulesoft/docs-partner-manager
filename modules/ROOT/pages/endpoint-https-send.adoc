...
Your organization's HTTP and HTTPS send endpoint settings configure where to send messages in the following contexts:
...
Hosts and partners can own HTTP and HTTPS send endpoints.
