...
When new runtime templates are available, the *Manage deployments* button is enabled with these options:
...
+
Updates all the Mule applications in your runtime with the latest available template versions.
