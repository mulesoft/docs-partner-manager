...
Refer to these when configuring either JSON or X12. Refer to 
[X12 EDI supported Doc Types] https://docs.mulesoft.com/connectors/x12-edi/x12-edi-supported-doc-types for more information.
