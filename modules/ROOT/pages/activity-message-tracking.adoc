...
+
Partner Manager returns a list of messages that meet your search criteria along with related information such as *xxx*.
+
...
//// * Date and time when the source endpoint received the message was received from the source endpoint
////
...
////
* Data and time when the target endoint received the message or when the message errored.
////
