...
.Your admnistrator maps an input path and target app to an output path in the DLB.
image::URL-mapping-rules-http.png[URL mapping rules in the DLB settings]
