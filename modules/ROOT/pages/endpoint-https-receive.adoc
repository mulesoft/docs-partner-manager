...
| Enable this setting to manage the endpoint with API Manager. If enabled, you must create:
* A new HTTP API in API Manager in the same environment as the endpoint.
* An instance ID for the API in the *API Auto-discovery ID* field.
