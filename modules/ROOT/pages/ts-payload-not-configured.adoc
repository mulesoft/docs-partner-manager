...
. If your payload storage is not configured, configure it according to https://docs.mulesoft.com/partner-manager/2.x/setup-payload-storage-API[Set up the Payload Storage API].
