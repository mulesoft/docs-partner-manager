...
.. To create a new message type, click *New* next to the search box, configure the xref:partner-manager-create-message-type.adoc[message type], and click *Save*.
...
If your source message type is EDI X12 or EDIFACT, follow these instruction to create the inbound EDI-to-application message in Anypoint Studio.

If your source message type is JSON or XML:  You can create your JSON/XML to JSON/XML map to convert your partner message format to your internal application format, follow these instructions.
...
To create a new translation map,

If the source message type is JSON or XML, follow the instructions in
