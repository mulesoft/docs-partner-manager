...
A translation map in an inbound message flow transforms your inbound message format to your organization's enterprise application format. Maps are created using DataWeave and are imported to the xref:maps.adoc[Maps] page. For more information about creating maps, see xref:partner-manager-maps.adoc[Translation Maps].
