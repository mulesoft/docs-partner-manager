...
If the source message type is X12, select the partner and the host organization's ISA (Interchange) identifiers from the dropdown menu.

If the source message type is EDIFACT, select the partner and the host organization's UNA (Interchange) identifiers from the dropdown menu.

If the source message type is CSV, JSON, or XML, select the partner and host organization's reference identifiers from the dropdown menu.
