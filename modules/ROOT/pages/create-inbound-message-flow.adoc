...
* Click *New* to create a new Receive from Partners endpoint, as described in xref:create-endpoint.adoc[Create Endpoints].
+
...
* Click *New* to create a new send to endpoint, as described in xref:create-endpoint.adoc[Create Endpoints].
...
. In the *Select message type* window, do either of the following:
* Se;ect an existing Target at Host message type and click *Select*.
...
* Click *New* to create a new Target at Host endpoint, as described in xref:create-endpoint.adoc[Create Endpoints].
