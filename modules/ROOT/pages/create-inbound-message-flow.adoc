...
.. To create a new message, click *New* on the right side of the search box and configure the X12 or EDIFACT message type.
The message type and its validation settings are added to the message flow.
. In the *Acknowledgment* section, select the check box next to *Send 997 functional acknowledgment* or *Send CONTROL functional acknowledgement* if your partner expects your organization to return functional acknowledgments.
