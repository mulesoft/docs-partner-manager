...
A translation map in an inbound message flow transforms your inbound messages from the EDIFACT EDI or X12 EDI format to your organization's enterprise application format, such as JSON and XML. Create a translation map by using DataWeave. For more information, see ref:partner-manager-maps.adoc[EDI Translation Maps].
