...
.. To create a new message, click *New* on the right side of the search box and configure the X12 or EDIFACT xref:partner-manager-create-message-type.adoc[message type].
The message type and its validation settings are added to the message flow.
. In the *Acknowledgment* section, select the check box next to *Send 997 functional acknowledgment (X12)* or *Send CONTROL functional acknowledgement (EDIFACT)* if your partner expects your organization to return functional acknowledgments.
