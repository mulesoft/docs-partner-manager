...
* Click *New* to create a new Receive from Partners messsage type, as described in xref:partner-manager-create-message-type.adoc[Create and Configure Message Types].
...
* Click *New* to create a new Target at Host endpoint, as described in xref:create-endpoint.adoc[Create and Configure Endpoints].
