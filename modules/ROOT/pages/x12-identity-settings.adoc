...
These settings apply to all X12 settings received from all partners. You can override these for your individual partner.
...
If you choose *Custom*, you can define your trading partner's EDI X12 qualifier.
