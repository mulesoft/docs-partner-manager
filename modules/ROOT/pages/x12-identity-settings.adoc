...
|Identifier Value
|The DUNS number for your partner. The DUNS number is a nine-digit number that your partner needs to supply you with that corresponds to the Sender/Receiver ID.
