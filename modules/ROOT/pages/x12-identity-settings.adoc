...
Identifiers are used to `identify` appropriate sender and receiver partners involved in a B2B transaction. For X12 messages, the identifiers contained in the ISA and GS headers provide valuable information to enable identification of the appropriate flow to that will be used to process the transaction.
...
|Identifier Value
|the DUNS number for your trading partner. The DUNS number is a 9 digit number that your trading partner should supply you with corresponding to the Sender / Receiver ID.
