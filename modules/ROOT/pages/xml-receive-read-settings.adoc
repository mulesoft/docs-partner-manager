= Configuring Receive Settings for Inbound XML Messages

Partner Manager receive settings include the EDIFACT acknowledgments and validation rules to apply when processing an inbound XML message from the specified partner.
