...
Partner Manager environments support up to 2,000 endpoints. To maximize your environment's capacity, reuse endpoint configurations across partners and message flows.
