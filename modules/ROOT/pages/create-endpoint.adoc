...
A single Partner Manager environment supports a maximum of 2,000 endpoints. To maximize your environment's capacity, reuse endpoint configurations across partners and message flows.
...
For information about using the Message Flow wizard to create new endpoints, see xref:create-inbound-message-flow.adoc[Create Inbound Message Flows] and xref:create-outbound-message-flow.adoc[Create Outbound Message Flows].
