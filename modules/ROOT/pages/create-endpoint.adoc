...
. <<configure-endpoint,Configure the endpoint>> according to the type of endpoint you are creating and the protocol you selected in the *New endpoint: <endpoint-type>* window.
. Click *Save*.
