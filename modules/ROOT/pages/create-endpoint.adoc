...
The send endpoints for SFTP Receive, SFTP Send, AS2 Send and HTTP(s) are always managed within a single generic endpoint service for the protocol & direction.
