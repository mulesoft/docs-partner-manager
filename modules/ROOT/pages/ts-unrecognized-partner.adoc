...
* Partner Manager cannot identify the host for the transmission because the identifier associated with the host is not configured.

* Partner Manager cannot identify both the partner and the host of this transmission.

== Solutions

Verifty partner and host identifiers.
