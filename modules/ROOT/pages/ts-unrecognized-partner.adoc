...
=== Verify Trading Partner's Identifiers

Verify that your trading partner has the appropriate identifiers configured as needed to support the transmission.
...
. Provide a value for your identifier (and a qualifier for X12-ISA) and click *Create identifier* to save your changes. See xref:x12-identity-settings.adoc[Identifiers] for more information on X12-ISA settings.
