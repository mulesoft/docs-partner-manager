...
Use Anypoint Connector for X12 or Anypoint Connector for EDIFACT with DataWeave 2.0
to create EDI translation maps in Anypoint Studio and then import the maps to Partner Manager when you configure inbound and outbound message flows.
