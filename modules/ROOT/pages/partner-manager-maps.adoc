...
When you configure a message flow, you can select the `.dwl` file on the *Select a map* page of the message flow. You can also change the map selection on a deployed message flow.
