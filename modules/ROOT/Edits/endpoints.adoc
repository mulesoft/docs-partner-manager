...
When creating partner-facing endpoints directly from the partner, or 3rd party connection, the ownership of the endpoint is automatically assigned to the entity from which the endpoint was created.
