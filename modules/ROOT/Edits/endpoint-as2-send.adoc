...
|Partner AS2 URL
|The partner or 3rd party connection AS2 URL to which outbound EDI transmissions are sent.
|Yes
...
|MDN response
|The AS2 messages sent from Partner Manager always request the receiver to return a Synchronous MDN receipt back. The default is `Sync`.
| Yes
|===
