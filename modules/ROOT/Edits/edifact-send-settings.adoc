= Configure Send Settings for Outbound EDIFACT Messages
...
|CRLF
|Test Indicator
a| When you select *Test* from the dropdown menu, sets UNB-11 to `1`, which indicates that this is a test message
|Production
|===
