...
Configuring a Business Process is done using xref:anypoint-partner-manager-api.adoc[Anypoint Partner Manager API]. This page shows an example of the necessary calls.
