...
* Support for many xref:supported-edi-document-types.adoc[common EDIFACT versions] out of the box
...
To use the EDIFACT Module in conjunction with Maven, see http://mulesoft.github.io/edi-module/edifact/guide/install.html[Mule EDI Anypoint EDIFACT Connector].
...
If you wish, you can also define your own schemas from scratch. See the xref:edi-schema-language-reference.adoc[EDI Schema Language Reference] for more details.
...
+
image::edi-choose-global-type.png[]
+
...
After you set up a global element for your EDIFACT module, configure the schemas, acknowledgements, IDs, and the parser options. A reference for these options is located in the http://mulesoft.github.com/edi-module[module reference].
